...
class UserAnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_answer" do
    assert_difference('UserAnswer.count') do
      post user_answers_url, params: { user_answer: { competition_id: @user_answer.competition_id, question_id: @user_answer.question_id, status: @user_answer.status, user_id: @user_answer.user_id } }
    end
  ...
  test "should update user_answer" do
    patch user_answer_url(@user_answer), params: { user_answer: { competition_id: @user_answer.competition_id, question_id: @user_answer.question_id, status: @user_answer.status, user_id: @user_answer.user_id } }
