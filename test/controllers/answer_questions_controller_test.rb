...
class AnswerQuestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer_question" do
    assert_difference('AnswerQuestion.count') do
      post answer_questions_url, params: { answer_question: { answer_id: @answer_question.answer_id, question_id: @answer_question.question_id } }
    end
  ...
  test "should update answer_question" do
    patch answer_question_url(@answer_question), params: { answer_question: { answer_id: @answer_question.answer_id, question_id: @answer_question.question_id } }
